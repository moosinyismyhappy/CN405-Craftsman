...
class GuiTracking():
    ...
    def __tracking_direction(self, center_position):
        ...
        if len(self.input1_list) == self.gui.get_input1_calibrate_time():
            ...
            # is first created rectangle
            if len(self.rectangle_list) == 0:
                # add first rectangle to list
                self.rectangle_list.append(self.input1_calibrate_area)
                ...
                for i in range(len(self.rectangle_list)):
                    result = self.is_rectangle_overlap(self.rectangle_list[i], self.input1_calibrate_area)
                    if result:
                        result = self.where_rectangle_overlap(self.rectangle_list[i], self.input1_calibrate_area)
                        self.overlap_resolution(result, self.rectangle_list[i], self.work_calibrate_area)
                        # add no overlap rectangle to list
                        self.rectangle_list.append((x1, y1, x2, y2))
                if counter == 0:
                    # add no overlap rectangle to list
                    self.rectangle_list.append((x1, y1, x2, y2))
                    self.x1 = x1
            ...
            # enable display area
            self.display_input1_area = True
            self.input1_calibrate_area = self.x1,self.y1,self.x2,self.y2
        ...
        if len(self.input2_list) == self.gui.get_input2_calibrate_time():
            ...
            if len(self.rectangle_list) == 0:
                # add first rectangle to list
                self.rectangle_list.append(self.input2_calibrate_area)
                ...
                counter = 0
                for i in range(len(self.rectangle_list)):
                    result = self.is_rectangle_overlap(self.rectangle_list[i], self.input2_calibrate_area)
                    if result:
                        result = self.where_rectangle_overlap(self.rectangle_list[i], self.input2_calibrate_area)
                        self.overlap_resolution(result, self.rectangle_list[i], self.work_calibrate_area)
                        # add no overlap rectangle to list
                        self.rectangle_list.append((x1, y1, x2, y2))
                if counter == 0:
                ...
                # enable display area
                self.display_input2_area = True
                self.input2_calibrate_area = self.x1, self.y1, self.x2, self.y2
        ...
        if len(self.output_list) == self.gui.get_output_calibrate_time():
            ...
            if len(self.rectangle_list) == 0:
                # add first rectangle to list
                self.rectangle_list.append(self.output_calibrate_area)
                ...
                counter = 0
                for i in range(len(self.rectangle_list)):
                    result = self.is_rectangle_overlap(self.rectangle_list[i], self.output_calibrate_area)
                    if result:
                        result = self.where_rectangle_overlap(self.rectangle_list[i], self.output_calibrate_area)
                        self.overlap_resolution(result, self.rectangle_list[i], self.output_calibrate_area)
                        # add no overlap rectangle to list
                        self.rectangle_list.append((x1, y1, x2, y2))
                if counter == 0:
                    # add no overlap rectangle to list
            ...
            # enable display area
            self.display_output_area = True
            self.output_calibrate_area = self.x1, self.y1, self.x2, self.y2
            print(self.output_calibrate_area)
        ...
        if len(self.work_list) == self.gui.get_work_calibrate_time():
            ...
            if len(self.rectangle_list) == 0:
                # add first rectangle to list
                self.rectangle_list.append(self.work_calibrate_area)
                ...
                counter = 0
                for i in range(len(self.rectangle_list)):
                    result = self.is_rectangle_overlap(self.rectangle_list[i], self.work_calibrate_area)
                    if result:
                        result = self.where_rectangle_overlap(self.rectangle_list[i], self.work_calibrate_area)
                        self.overlap_resolution(result, self.rectangle_list[i], self.work_calibrate_area)
                        # add no overlap rectangle to list
                        self.rectangle_list.append((x1, y1, x2, y2))
                if counter == 0:
            ...
            # enable display area
            self.display_work_area = True
            self.work_calibrate_area = self.x1, self.y1, self.x2, self.y2
